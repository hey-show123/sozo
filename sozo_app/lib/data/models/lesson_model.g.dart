...
_LessonModel _$LessonModelFromJson(Map<String, dynamic> json) => _LessonModel(
      ...
      vocabularyQuestions: json['vocabulary_questions'] == null
          ? const []
          : _vocabularyQuestionsFromJson(json['vocabulary_questions']),
      ...
      characterId: json['character_id'] == null
          ? 'sarah'
          : _characterIdFromJson(json['character_id']),
...
Map<String, dynamic> _$LessonModelToJson(_LessonModel instance) =>
    <String, dynamic>{
      ...
      'vocabulary_questions': instance.vocabularyQuestions,
