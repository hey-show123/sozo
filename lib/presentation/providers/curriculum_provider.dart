  ...
  List<lesson_model.LessonModel> _getBusinessLessons() {
    return [
      lesson_model.LessonModel(
        ...
        scenario: const lesson_model.ConversationScenario(
          situation: 'オンラインビジネスミーティング',
          location: 'Zoomミーティングルーム',
          aiRole: 'プロジェクトマネージャー',
          userRole: 'チームメンバー',
          context: 'プロジェクトの進捗報告と次のステップについて話し合います',
          suggestedTopics: ['進捗報告', 'タスクの割り振り', '期限の確認'],
        ),
        keyPhrases: [
          const lesson_model.KeyPhrase(
            phrase: "Let's get started with today's meeting",
            meaning: '今日のミーティングを始めましょう',
            usage: 'ミーティングの開始を告げる時に使用',
            examples: [
              "Let's get started with today's meeting. We have a lot to cover.",
              "Shall we get started? I see everyone is here.",
            ],
          ),
        ],
        grammarPoints: [],
      ...
      lesson_model.LessonModel(
        ...
        scenario: const lesson_model.ConversationScenario(
          situation: '四半期業績プレゼンテーション',
          location: '会議室',
          aiRole: '上司',
          userRole: 'プレゼンター',
          context: '四半期の業績をチームに報告します',
          suggestedTopics: ['売上データ', '市場動向', '今後の戦略'],
        ),
        keyPhrases: [],
        grammarPoints: [],
        pronunciationFocus: null,
  ...
  List<lesson_model.LessonModel> _getDailyLessons() {
    return [
      lesson_model.LessonModel(
        ...
        scenario: const lesson_model.ConversationScenario(
          situation: 'カジュアルレストランでの夕食',
          location: 'レストラン',
          aiRole: 'ウェイター/ウェイトレス',
          userRole: 'お客様',
          context: '友人とカジュアルなレストランで夕食を楽しみます',
          suggestedTopics: ['メニューの質問', 'おすすめ料理', 'アレルギー情報'],
        ),
        keyPhrases: [
          const lesson_model.KeyPhrase(
            phrase: "Could I see the menu, please?",
            meaning: 'メニューを見せていただけますか？',
            usage: 'メニューを頼む時の丁寧な表現',
            examples: [
              "Could I see the menu, please? I'm ready to order.",
      ...
      lesson_model.LessonModel(
        ...
        scenario: const lesson_model.ConversationScenario(
          ...
          aiRole: '地元の人',
          userRole: '観光客',
          context: '観光地で目的地への道を尋ねます',
          suggestedTopics: ['観光スポット', '交通手段', '所要時間'],
        ),
        keyPhrases: [],
        grammarPoints: [],
        pronunciationFocus: null,
