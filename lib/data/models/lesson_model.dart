...
abstract class LessonModel with _$LessonModel {
  const factory LessonModel({
    ...
    @JsonKey(fromJson: _scenarioFromJson) required ConversationScenario scenario,
...
ConversationScenario _scenarioFromJson(dynamic value) {
  ...
  return ConversationScenario.fromJson(value);
}
...
abstract class ConversationScenario with _$ConversationScenario {
  const factory ConversationScenario({
    ...
    required List<String> suggestedTopics,
